...
<head>
  ...
  ?>
  <title>MAPDR | instituições</title>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div data-aos="fade-left" class="single-blog-d">
                  ...
                  <h4>
                    Instituições do Ministério da Agricultura, Pescas e Desenvolvimento Rural
                  </h4>

                  <p>O Ministério de Agricultura, Pescas e Desenvolvimento Rural compreende as seguintes instituições:
                  </p>
                    ...
                    <ul>
                      <li class="principal">
                        ...
                        <div id="faq-list-1" class="collapse-show" data-bs-parent=".faq-list">
                          <ul>
                            <?php
                            require("ajax/sector-instituicao.php");
                            ?>
                          </ul>
                        </div>
                      </li>
