...
$(function() {
    ...
    $("#entityContent")
        .html("<img src='images/preloader-01.gif' />")
        .load("ajax/entity/view.php", "page=" + num+"&type=projecto", function () {
            var total = $("#total").val();
            for (var i = 0; i < total; i++) {
                $("#modificar" + i).tooltip({
                    show: {
...
function modificaEntityAsync() {
    ...
    $.post("ajax/entity/update.php",
        ...
        function (data) {
            ...
            if (result > 0) {
                $("#modificarentityState").html("<p>Os seus dados foram Modificar com êxito!</p>");
                $("#entityContent").html("<img src='images/preloader-01.gif' />").load("ajax/entity/view.php", "page=" + num + "&type=projecto", function () { });
...
function adicionarEntityAsync() {
    ...
    $.post("ajax/entity/insert.php",
        ...
        function (data) {
            var result = parseInt(data.text);
                      if (result > 0) {
                $("#adicionarentityState").html("<p>Os seus dados foram adicionados com êxito!</p>");
                $("#entityContent").html("<img src='images/preloader-01.gif' />").load("ajax/entity/view.php", "page=" + num + "&type=projecto", function () { });
                $("#adicionarentityDialogo").dialog('option', 'buttons',
                    {
                        'Fechar': function () {
