    ...
    if ($row1 = mysqli_fetch_array($result)) {
        ...
        if ($num > 0) {
            ...
            while ($row = mysqli_fetch_array($result)) {
                echo "<tr style='border:hidden'><td style='border:hidden'><a id='modificar" . $i . "' title='Modificar documento " . $row['title'] . "' href='javascript:modificar(" . $row['id'] . ")'><img src='images/update.png' height='28px' width='28px'/></a>";
                ...
                echo "<td style='border:hidden'><a id='anexo" . $i . "' title='Gestao dos anexos do documento " . $row['title'] . "' href='biblioteca_anexo.php?aid=" . $row['id'] . "&atitulo=" . $row["title"] . "' style='top: 5px; position: relative;' class='art-button'>Anexos</a></td>";
