            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div data-aos="fade-left" class="single-blog-d">
                  ...
                  <h4>
                    Gabinetes do Ministério da Agricultura, Pescas e Desenvolvimento Rural
                  </h4>

                  <p>O Ministério de Agricultura, Pescas e Desenvolvimento Rural compreende os seguintes gabinetes:
                  </p>
                    ...
                    <ul>
                      <li class="principal">
                        ...
                        <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                          <ul>
                            <?php
                            require("ajax/sector-gabinete.php");
                            ?>
                          </ul>
                        </div>
                      </li>
